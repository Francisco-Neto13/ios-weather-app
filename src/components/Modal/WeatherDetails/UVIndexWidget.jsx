...
const UVIndexWidget = ({
  ...
  return (
    <div style={smallWidgetCardStyle}>
      ...
      <div>
        <p style={{ margin: 0, fontSize: '40px', fontWeight: 400, color: '#FFFFFF', lineHeight: 1 }}>{displayValue}</p>
        <p
          style={{
      ...
      <div style={{ position: 'relative', height: '4px', borderRadius: '2px', background: 'rgba(255, 255, 255, 0.15)' }}>
        ...
        <div style={{ position: 'absolute', left: `${displayProgress * 100}%`, top: '50%', transform: 'translate(-50%, -50%)', width: '10px', height: '10px', borderRadius: '50%', background: '#FFFFFF', border: '2px solid #5B8EF0' }} />
      </div>
    </div>
  );
};
